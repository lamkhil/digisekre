...
class EditPendidikan extends Page
{
    protected static string $resource = ProfileResource::class;

    protected static string $view = 'filament.anggota.resources.profile-resource.pages.edit-pendidikan';

    public ?array $data = [];

    public function mount()
    {
        $pendidikan = Auth::user()->pendidikan?->toArray() ?? [];
        $data = [];
