            ...
            <div>
                <div class="overflow-x-auto hide-scrollbar border-b-2 md:border-b-0">
                    <ul class="flex border-b-0 md:border-b-2 space-x-3 md:space-x-6 flex-nowrap md:flex-wrap">
                        ...
                        <li class="-mb-0.5">
                            <a class="whitespace-nowrap text-base md:font-semibold px-2 md:px-4 py-2 flex border-b-2 {{ ($active??null) == 'iuran' ? 'text-primary-500 border-primary-500' : 'text-sonic-silver border-transparent' }}" href="{{ route('filament.anggota.resources.profiles.iuran') }}"><span class="whitespace-nowrap">Iuran</span></a>
                        </li>
                        <li class="-mb-0.5">
                            <a class="whitespace-nowrap text-base md:font-semibold px-2 md:px-4 py-2 flex border-b-2 {{ ($active??null) == 'ktp' ? 'text-primary-500 border-primary-500' : 'text-sonic-silver border-transparent' }}" href="{{ route('filament.anggota.resources.profiles.ktp') }}"><span class="whitespace-nowrap">KTP</span></a>
                        </li>
                        <li class="-mb-0.5">
